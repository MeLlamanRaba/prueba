 ...
 * @author Sonia
 */
public class HuevoSorpresaSamuelTest {
    
    public HuevoSorpresaSamuelTest() {
    }
...
//        HuevoSorpresaSamuel instance = new HuevoSorpresaSamuel();
//        int expResult = 0;
...
//    }
    ...
    public void testSacarHuevoSorpresaValido() throws Exception {
        ...
        int unidades = 10;
        double dinero = 15;
        HuevoSorpresaSamuel instance = new HuevoSorpresaSamuel(200,1,"Peppa Pig",2);
